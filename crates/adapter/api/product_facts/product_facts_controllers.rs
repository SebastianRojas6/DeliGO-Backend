use crate::api::product_facts::product_facts_mappers::{ProductFactPresenterMapper, ProductFactUpdateMapper};
...
async fn update_product_fact(data: web::Data<AppState>, payload: web::Json<UpdateProductFactPayload>) -> Result<HttpResponse, ErrorResponse> {
    let product_fact = ProductFactUpdateMapper::to_dto(payload.into_inner());
